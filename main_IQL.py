...
from models.factory_IQL import create_policy
...
def main():
    ...
    for j in tqdm(range(num_updates)):
        for step in range(args.num_steps):
            ...
            # print('train_envs.step',type(train_envs))
            ...
            for info in infos:
                if 'episode' in info.keys():
                    #print('info_episode11',info['episode'])
        ...
        if j % args.log_interval == 0 and len(episode_rewards) > 1:
            #print('episode_rewards2_main2v2',episode_rewards)
        ...
        np.savetxt('./results/Team_IQL/train_score_seed_{}.csv'.format(42),
                   np.array(log_mean),
                   delimiter=";")
        np.savetxt('./results/Team_IQL/train_scorestd_seed_{}.csv'.format(42),
                   np.array(log_std),
                   delimiter=";")
        np.savetxt('./results/Team_IQL/train_dist_entropy_seed_{}.csv'.format(42),
                   np.array(log_dist_entropy),
                   delimiter=";")
        np.savetxt('./results/Team_IQL/train_dist_entropystd_seed_{}.csv'.format(42),
