...
class RolloutStorage(object):
    #print('####')
    def __init__(self, num_steps, num_processes, obs_shape, action_space,num_quant, recurrent_hidden_state_size):
        self.obs = torch.zeros(num_steps + 1, num_processes, *obs_shape)
        self.recurrent_hidden_states = torch.zeros(num_steps + 1, num_processes, recurrent_hidden_state_size)
        self.rewards = torch.zeros(num_steps, num_processes, 1)
        self.value_preds = torch.zeros(num_steps + 1, num_processes, num_quant)
        self.returns = torch.zeros(num_steps + 1, num_processes, num_quant)
