...
from .policy_opp import Policy


def create_policy(obs_space, action_space,opp_agents,num_quant, name='basic', nn_kwargs={}, train=True):
    #print('@@@')
    nn = None
    ...
    policy = Policy(nn, action_space=action_space,opp_agents=opp_agents)
