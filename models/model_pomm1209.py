...
class CriticNet(NNBase):
    ...
    def __init__(self, obs_shape,agent_num, recurrent=False, hidden_size=512, batch_norm=True, cnn_config='conv4'):
        ...
        self.critic = nn.Sequential(
            nn.Linear(1+agent_num+hidden_size + hidden_size//4, 6),
            nn.Tanh()
        )
