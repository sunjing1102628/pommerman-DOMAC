...
class VecPyTorch(VecEnvWrapper):
    ...
    def reset(self):
        ...
        obs = self.venv.reset() #<class 'numpy.ndarray'>
...
class VecPyTorchFrameStack(VecEnvWrapper):
    ...
    def reset(self):
        obs = self.venv.reset()
        #print('obs_VecPyTorchFrameStack',type(obs))
...
'''def main():
    from models.factory1203 import create_policy
    import algo
    ...
    print('obs_main',type(obs))
    print('obs_make_env2',obs.size())'''
